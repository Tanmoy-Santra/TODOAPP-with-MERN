...
const Home = () => {
  ...
  const handleToggleComplete = async (id, isCompleted) => {
    try {
      ...
      const res = await axios.put(
        `${import.meta.env.VITE_APIURL}/api/todos/${id}`,
 ...
 if (!user) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6">
        <h2 className="text-2xl font-bold text-blue-600 mb-4">Welcome to Todo App 📝</h2>
        <p className="text-gray-700 mb-6">
          Please login to access your todos. If you are new, sign up and start managing your tasks easily.
        </p>
